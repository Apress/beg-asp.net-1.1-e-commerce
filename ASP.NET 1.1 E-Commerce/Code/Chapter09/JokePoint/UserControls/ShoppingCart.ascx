...
<P>
	<asp:Label id="Label2" runat="server" CssClass="ProductDescription">Total Amount:</asp:Label>
	<asp:Label id="totalAmountLabel" runat="server" CssClass="ProductPrice"></asp:Label></P>
<P>
