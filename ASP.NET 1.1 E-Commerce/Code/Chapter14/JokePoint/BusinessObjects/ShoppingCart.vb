...
Public Class ShoppingCart
    ...
    Public Function CreateOrder(ByVal customerID As Integer) As Integer
        ' Create the connection object
        Dim connection As New SqlConnection(connectionString)
        ' Create and initialize the command object
        Dim command As New SqlCommand("CreateCustomerOrder", connection)
        command.CommandType = CommandType.StoredProcedure
        ' Add input parameters and supply values for them
    ...
    Public Shared Function GetSimilarProducts() As SqlDataReader
        ' Create the connection object
        Dim connection As New SqlConnection(connectionString)
        ' Create and initialize the command object
        Dim command As New SqlCommand("GetSimilarProducts", connection)
        command.CommandType = CommandType.StoredProcedure
        ' Add an input parameter and supply a value for it
        command.Parameters.Add("@CartID", SqlDbType.Char, 36)
        command.Parameters("@CartID").Value = shoppingCartId
