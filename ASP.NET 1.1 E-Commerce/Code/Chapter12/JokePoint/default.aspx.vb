...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ' Check for HTTPS (SSL) connection
        If Context.Request.IsSecureConnection Then
            ' Redirect to standard HTTP
            If Session.IsCookieless Then
                Response.Redirect("http://" & Request.Url.Host _
                & Request.ApplicationPath & "/(" & Session.SessionID & ")/default.aspx")
            Else
                Response.Redirect("http://" & Request.Url.Host _
